...
auction_opening_price_cent_kwh_h_runtime           = 'auction opening price (c/(kWh/h)/runtime)'
auction_opening_alternate_price_cent_kwh_h_runtime = 'auction opening alternate price (c/(kWh/h)/runtime)'
auction_price_alternate_cent_kwh_h_runtime = 'auction price alternate (c/(kWh/h)/runtime)'
auction_price_euro_mwh    = 'auction price (€/MWh)'
auction_price_cent_kwh_h_runtime = 'auction price (c/(kWh/h)/runtime)'
auction_pricing           = 'auction pricing'
auction_power_mw          = 'auction power (MW)'
auction_start_dt_local    = 'auction_start_dt (local)'
auction_state             = 'auction_state'
auction_state_cancelled   = 'cancelled'
auction_state_finished    = 'finished'
auction_surcharge_cent_kwh_h_runtime = 'auction_surcharge (cent/(kWh/h)/runtime)'
auction_surcharge_unit    = 'auction_surcharge_unit'
...
capacity_category_interruptible = 'interruptible'
capacity_category_firm      = 'firm'
capacity_category_firm_firm = 'firm_firm'
...
capacity_marketable_kwh_h   = 'capacity_marketable (kWh/h)'
capacity_marketable_unit    = 'capacity_marketable_unit'
capacity_marketed_kwh_h     = 'capacity_marketed (kWh/h)'
capacity_marketed_unit      = 'capacity_marketed_unit'
capacity_month_utc          = 'capacity month (UTC)'
capacity_nominal_gw         = 'nominal capacity (GW)'
capacity_nominal_mw         = 'nominal capacity (MW)'
capacity_published_kwh_h    = 'capacity_published (kWh/h)'
capacity_published_unit     = 'capacity_published_unit'
...
contract_frequency_within_day           = 'WD'
...
point_entry_tso  = 'point_entry_tso'
point_exit       = 'point_exit'
point_exit_tso   = 'point_exit_tso'
point_exit_entry = 'point_exit_entry'
...
### Tariffs
tariff_entry_cent_kwh_h_runtime = 'tariff_entry_cent_kWh_h_runtime'
tariff_entry_unit               = 'tariff_entry_unit'
tariff_exit_cent_kwh_h_runtime  = 'tariff_exit_cent_kWh_h_runtime'
tariff_exit_unit                = 'tariff_exit_unit'
