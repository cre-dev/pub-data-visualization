...
def piecewise_constant_interpolators(x,
    ...
    """
        Returns the points to interpolate 
        to draw a piecewise constant function.
 
        :param x: The x-coordinates of the steps
        :param y: The y-coordinates of the steps
        :param smoother: Boolean to draw oblique instead of vertical steps
        :type x: list of floats
        :type y: list of floats
        :type smoother: string
        :return: The coordinates of the points to interpolate
