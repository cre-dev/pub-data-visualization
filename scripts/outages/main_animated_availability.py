...
unit_name = None
production_dt_min = pd.Timestamp("2019-01-01").tz_localize(global_var.dikt_tz[map_code])
production_dt_max = pd.Timestamp("2020-01-01").tz_localize(global_var.dikt_tz[map_code])
publication_dt_min = pd.Timestamp("2019-01-01").tz_localize(global_var.dikt_tz[map_code])
publication_dt_max = pd.Timestamp("2020-01-01").tz_localize(global_var.dikt_tz[map_code])
###############################################################################
