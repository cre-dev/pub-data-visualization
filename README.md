...
This figure, that represents the fixing prices of the day-ahead auctions, is obtained by running `pub_scripts/auctions/main_price.py`.
...
This figure, obtained by running `pub_scripts/load/main_power.py`, is a mere representation of the load curve.
...
This figure represents the national load forecasting error and is obtained by running `pub_scripts/load/main_forecasting_error.py`.
...
This figure is obtained by running `pub_scripts/outages/main_animated_availability.py`.
...
This figure is obtained by running `pub_scripts/outages/main_evolution_mean_availability.py`.
The data have to be downloaded manually from ENTSO-E or RTE platforms.
...
This figure is obtained by running `pub_scripts/outages/main_expected_program.py`.
The data have to be downloaded manually from ENTSO-E or RTE platforms.

### Availability programs
![Availability programs](examples/outages/incremental_programs.png)
This figure is obtained by running `pub_scripts/outages/main_incremental_programs.py`.
The data have to be downloaded manually from ENTSO-E or RTE platforms.
...
This figure is obtained by running `pub_scripts/production/main_power.py`.
...
This figure is obtained by running `pub_scripts/weather/main_curve.py`.
...
This figure is obtained by running `pub_scripts/weather/main_distribution.py`.
The data, provided by Météo-France, are downloaded automatically.
...
This figure is obtained by running `pub_scripts/multiplots/main_spot_report.py`.
...
This figure is obtained by running `pub_scripts/multiplots/main_transparent_production.py`.
...
## Documentation
An html documentation generated with Sphinx can be found in ./pub_doc/pub_data_visualization.html.
